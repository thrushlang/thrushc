...
use super::super::{Instruction, call, symbols::SymbolsTable, typegen, unaryop, utils, valuegen};
...
pub fn float_binaryop<'ctx>(
    ...
    {
        let mut left_compiled: FloatValue = symbols
        ...
        let mut right_compiled: FloatValue = symbols
