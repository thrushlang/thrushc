use crate::backend::llvm::compiler::constants::LLVM_COMPILER_SYMBOLS_GLOBAL_MINIMAL_CAPACITY;
use crate::backend::llvm::compiler::constants::LLVM_COMPILER_SYMBOLS_LOCAL_MINIMAL_CAPACITY;
use crate::backend::llvm::compiler::memory::SymbolAllocated;

use crate::backend::llvm::types::repr::LLVMFunction;
use crate::backend::llvm::types::repr::LLVMFunctions;
use crate::backend::llvm::types::repr::LLVMFunctionsParameters;
use crate::backend::llvm::types::repr::LLVMGlobalConstants;
use crate::backend::llvm::types::repr::LLVMGlobalStatics;
use crate::backend::llvm::types::repr::LLVMInstructions;
use crate::backend::llvm::types::repr::LLVMLocalConstants;
use crate::backend::llvm::types::repr::LLVMLocalStatics;
