...
use crate::backend::llvm::compiler::alloc::atomic::LLVMAtomicModificators;
use crate::backend::llvm::compiler::{abort, typegen};
use crate::frontend::types::ast::metadata::dereference::LLVMDereferenceMetadata;
use crate::{backend::llvm::compiler::alloc::atomic, frontend::lexer::span::Span};

use crate::frontend::types::ast::metadata::constant::LLVMConstantMetadata;
use crate::frontend::types::ast::metadata::local::LLVMLocalMetadata;
use crate::frontend::types::ast::metadata::staticvar::LLVMStaticMetadata;
