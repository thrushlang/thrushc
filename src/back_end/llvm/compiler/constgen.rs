...
use crate::back_end::llvm::compiler::binaryop;
use crate::back_end::llvm::compiler::constgen;
use crate::back_end::llvm::compiler::context::LLVMCodeGenContext;
use crate::back_end::llvm::compiler::generation::expressions::unary;
use crate::back_end::llvm::compiler::generation::float;
use crate::back_end::llvm::compiler::generation::integer;
use crate::back_end::llvm::compiler::{self, builtins};
...
pub fn compile<'ctx>(
    ...
    match ast {
        ...
        Ast::Float {
            ...
            compiler::generation::cast::const_numeric_cast(context, float, cast_type, *signed)
        }
        ...
        Ast::Integer {
            ...
            compiler::generation::cast::const_numeric_cast(context, integer, cast_type, *signed)
        }
