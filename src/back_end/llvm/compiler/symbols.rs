use crate::back_end::llvm::compiler::constants::LLVM_COMPILER_SYMBOLS_GLOBAL_MINIMAL_CAPACITY;
use crate::back_end::llvm::compiler::constants::LLVM_COMPILER_SYMBOLS_LOCAL_MINIMAL_CAPACITY;
use crate::back_end::llvm::compiler::memory::SymbolAllocated;

use crate::back_end::llvm::types::repr::LLVMFunction;
use crate::back_end::llvm::types::repr::LLVMFunctions;
use crate::back_end::llvm::types::repr::LLVMFunctionsParameters;
use crate::back_end::llvm::types::repr::LLVMGlobalConstants;
use crate::back_end::llvm::types::repr::LLVMGlobalStatics;
use crate::back_end::llvm::types::repr::LLVMInstructions;
use crate::back_end::llvm::types::repr::LLVMLocalConstants;
use crate::back_end::llvm::types::repr::LLVMLocalStatics;
