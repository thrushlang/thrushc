...
impl std::fmt::Display for TokenKind {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            TokenKind::Float => write!(f, "number"),
            ...
            TokenKind::AsmAlignStack => write!(f, "@asmalignstack"),
            TokenKind::AsmDialect => write!(f, "@asmdialect"),
            TokenKind::AsmSideEffects => write!(f, "@asmeffects"),
            TokenKind::AsmThrow => write!(f, "@asmthrow"),
